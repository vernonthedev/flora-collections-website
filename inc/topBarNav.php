        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdown<?php echo $crow['id'] ?>" href="#"
        ...
        <div class="mainmenu__search-bar p-relative">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <button class="mainmenu__search-icon" type="submit" id="button-addon2"><i class="fal fa-search"></i></button>
                </div>
            </div>
            </div>
        </form>
